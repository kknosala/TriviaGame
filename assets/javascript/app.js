$(document).ready(function() {
  ...
  var gameQuestions = {
    ...
    //Spanish
    question9:
      "What is Aladdin's monkey friend called in the Disney movie Aladdin?",
    answers9: ["Zazu", "Abu", "Moo Shu", "Babu"],
    //Abu
    question10:
      "Bram Stoker's Dracula lived in Transylvania. In what modern-day country can Transylvania be found in?",
      ...
      $(".answer-button").click(function() {
        ...
        if (gameVariables.answerQuestion) {
          ...
          if (y === 1) {
            ...
            $("#image").html(
              '<img src="assets/images/question1.gif" alt="A Coast Redwood" />'
            );
          } else if (y === 2) {
            ...
            $("#fun-fact").html(
              'Every actor in "Taxi Driver" took a massive paycut to make the film.'
            );
            $("#image").html(
              '<img src="assets/images/question2.gif" alt="Travis Clapping" />'
            );
          } else if (y === 3) {
            ...
            $("#fun-fact").html(
              "620,000 soliders died, more than WW1, WW2, and Vietnam combined."
            );
            $("#image").html(
              '<img src="assets/images/question3.gif" alt="Civil War Renactors" />'
            );
          } else if (y === 4) {
            ...
            $("#fun-fact").html(
              "The Stone Fish sting is described as the most intense pain known to man."
            );
            $("#image").html(
              '<img src="assets/images/question4.gif" alt"A Stone Fish" />'
            );
          } else if (y === 5) {
            if (answerChoice == "USA") {
              $(this).attr("class", "right");
            ...
            $("#fun-fact").html(
              "Alice Stevvins Wells became a police office in 1910."
            );
            $("#image").html(
              '<img src="assets/images/question5.gif" alt="A female police officer" />'
            );
          } else if (y === 6) {
            ...
            $("#fun-fact").html(
              "Dalmations develop their spots at 4 weeks old."
            );
            $("#image").html(
              '<img src="assets/images/question6.gif" alt="Dalmation Puppies" />'
            );
          } else if (y === 7) {
            ...
            $("#image").html(
              '<img src="assets/images/question7.gif" alt="Examples of Prime numbers" />'
            );
          } else if (y === 8) {
            ...
            $("#image").html(
              '<img src="assets/images/question8.gif" alt="Venezuelan Flag" />'
            );
          } else if (y === 9) {
            if (answerChoice == "Abu") {
              $(this).attr("class", "right");
            ...
            $("#fun-fact").html(
              "Robin Williams recorded over 16 hours of audio for the movie."
            );
            $("#image").html(
              '<img src="assets/images/question9.gif" alt="Abu looking at a jewel" />'
            );
          } else if (y === 10) {
            ...
            $("#image").html(
              '<img src="assets/images/question10.gif" alt="Dracula in his coffin" />'
            );
          }
    ...
    timeOut: function(y) {
      if (gameVariables.timer === 0) {
        ...
        if (y === 1) {
          $("#win-text").html(
            "<p>Out of Time!</p><p>The correct answer is: Coast Redwood</p>"
          );
          $("#fun-fact").html("Redwoods can reach 115 meters tall.");
          $("#image").html(
            '<img src="assets/images/question1.gif" alt="A Coast Redwood" />'
          ...
          $("#win-text").html(
            "<p>Out of Time!</p><p>The correct answer is: Travis Bickle</p>"
          );
          $("#fun-fact").html(
            'Every actor in "Taxi Driver" took a massive paycut to make the film.'
          );
          ...
          $("#win-text").html(
            "<p>Out of Time!</p><p>The correct answer is: American Civil War</p>"
          );
          $("#fun-fact").html(
            "620,000 soliders died, more than WW1, WW2, and Vietnam combined."
          );
          ...
          $("#win-text").html(
            "<p>Out of Time!</p><p>The correct answer is: Stone Fish</p>"
          );
          $("#fun-fact").html(
            "The Stone Fish sting is described as the most intense pain known to man."
          );
          ...
          $("#win-text").html(
            "<p>Out of Time!</p><p>The correct answer is: USA</p>"
          );
          $("#fun-fact").html(
            "Alice Stevvins Wells became a police office in 1910."
          );
          ...
          $("#win-text").html(
            "<p>Out of Time!</p><p>The correct answer is: White</p>"
          );
          ...
          $("#win-text").html(
            "<p>Out of Time!</p><p>The correct answer is: Prime Numbers</p>"
          );
          $("#fun-fact").html(
            "Prime numbers can only be divided by themselves and 1."
          );
          ...
          $("#win-text").html(
            "<p>Out of Time!</p><p>The correct answer is: Spanish</p>"
          );
          $("#fun-fact").html(
            "Venezuela is home to the world's largest rodent, the Capybara."
          );
          ...
          $("#win-text").html(
            "<p>Out of Time!</p><p>The correct answer is: Abu</p>"
          );
          $("#fun-fact").html(
            "Robin Williams recorded over 16 hours of audio for the movie."
          );
          ...
          $("#win-text").html(
            "<p>Out of Time!</p><p>The correct answer is: Romania</p>"
          );
  ...
  var print = {
    gameStats: function() {
      ...
      $("#incorrect").html(
        "Incorrect Answers: " + gameVariables.incorrectGuesses
      );
    },
    ...
    question: function(question, answers) {
      ...
      for (i = 0; i < 4; i++) {
        $("#answers").append(
          '<button class="answer-button" value="' +
            answers[i] +
            '">' +
            answers[i] +
            "</button><br>"
    ...
    finalScreen: function() {
      ...
      $("#win-text").html(
        "You got " + gameVariables.correctGuesses + " correct!"
      );
      $("#fun-fact").html(
        "You got " + gameVariables.incorrectGuesses + " wrong!"
      );
      $("#image").html('<button id="restart">Try Again?</button>');

      $("#restart").click(function() {
        console.log("clicked");
        gameVariables.correctGuesses = 0;
        gameVariables.incorrectGuesses = 0;
        gameVariables.timer = 10;
        gameVariables.clockRunning = false;
        gameVariables.questionNumber = 0;
        print.gameStats();
        print.playGame(1);
      });
    }
